...
## Paper Citation
Avcu, E., Hwang, M., Brown, K., Gow, D. (submitted). A tale of two lexica: Investigating computational pressures on word representation with deep neural networks. Submitted to Frontiers in Artificial Intelligence - Language and Computation.
